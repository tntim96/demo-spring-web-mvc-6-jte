...
class Config implements WebMvcConfigurer {
    ...
    TemplateEngine templateEngine(ServletContext context) throws MalformedURLException, URISyntaxException {
        ...
        Path classDirectory = Path.of(System.getProperty("java.io.tmpdir"), "jte-classes");
        return TemplateEngine.create(codeResolver, classDirectory, ContentType.Html, this.getClass().getClassLoader());
    }
